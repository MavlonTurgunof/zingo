...
function Home() {
  return (
    <div className="bg-[linear-gradient(to_bottom,rgba(255,255,255,0.8),rgba(255,85,110,0.2)),url('/img/dotted-background.svg')]  bg-cover bg-center border-10  border-white rounded-b-[60px] shadow-2xl">
      <div className="container mx-auto w-[50%] pt-[40px]">
